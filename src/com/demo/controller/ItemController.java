...
//	}
	...
	public ConfData getItemList(MyShopBean myShopBean){					//入参:页码,每页商品数量
		...
		confData.setData(myShopBean1);									//将商品信息列表添加到ConfData
		if(theRest>0){
			confData.setCode(200);
			confData.setMsg("还有"+(theRest)+"条数据");
		}else if (theRest==0){
			confData.setCode(201);
			confData.setMsg("没有更多数据啦");
		}else{
			confData.setCode(404);
			confData.setMsg("错误");
...
//		}
	...
	public HeadDataList responseHeadData(Stores stores){
	    HeadDataList headDataList =new HeadDataList();
        List<BannerDataList>bannerDataList = goodsService.getBannerDataList(stores);
...
//		String goods_headPath = "http://127.0.0.1:8080/ShopDemo/public/images/goods_head/goods_head_1.png";
		String SingleItem_1_TitleImgPath = "http://139.196.212.61:8080/ShopDemo/public/images/single_head/"+SingleItem_1_TitleImgName;
		String SingleItem_2_TitleImgPath = "http://139.196.212.61:8080/ShopDemo/public/images/single_head/"+SingleItem_2_TitleImgName;
		String unionTitleImgPath ="http://139.196.212.61:8080/goods/ShopDemo/images/union_head_/"+unionTitleImgName;
		String goods_headPath = "http://139.196.212.61:8080/ShopDemo/public/images/goods_head/goods_head_1.png";
		...
		headDataList.setData(headData);
		headDataList.setCode(200);
		headDataList.setMsg("test");
        return headDataList;
